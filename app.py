...
# --- CONFIG & THEME ---
st.set_page_config(page_title="URBAN-TRACE | GeoAI", layout="wide")
...
st.markdown("""
    ...
    html, body, [class*="css"] {
        ...
        background-color: #fae8f5; /* Your custom pinkish-white background */
    }
...
with col_left:
    ...
    # Check your file name matches exactly in GitHub
    st.image("map_placeholder.png", use_container_width=True, caption="Layer: Natural Flow Accumulation vs. Infrastructure")
    st.info("💡 **Logic Analysis:** Drainage segments in RED indicate elevation traps where topography contradicts infrastructure.")
...
with st.expander("Submit a Field Report"):
    ...
    with c2:
        ...
        if st.button("Submit for AI Validation"):
            st.info("Processing... Image queued for YOLOv8 verification.")
